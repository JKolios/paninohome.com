...
$sendto = 'panino@paninohome.com';

//        The subject you'll see in your inbox
$subject = 'Paninohome.com Contact Message';

//        Message for the user when he/she doesn't fill in the form correctly.
$errormessage = 'An error has occurred.';

//        Message for the user when he/she fills in the form correctly.
$thanks = "Thank you for your message, we will contact you as soon as possible.";
...
$emptytele = 'Please fill in your phone number.';
$emptymessage = 'Please type a message.';

//       Various messages displayed when the fields are incorrectly formatted.
$alertname =  'Please use only printable letters in the name field';
$alertemail = 'Please use an email following this format: <i>name@example.com</i>';
$alerttele = 'Please use a phone number following this format: <i>555-555-5555</i>';
$alertmessage = "Make sure you aren't using any parenthesis or other special characters in your message. Most URLS should be acceptable.";
