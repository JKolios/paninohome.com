...
$thanks = "Ευχαριστούμε για το μήνυμά σας, θα επικοινωνήσουμε μαζί σας σύντομα";

//        Message for the bot when it fills in in at all.
$honeypot = "You filled in the honeypot! If you're human, try again!";

//        Various messages displayed when the fields are empty.
$emptyname =  'Συμπληρώσατε το όνομά σας;';
$emptyemail = 'Συμπληρώσατε το email σας;';
$emptytele = 'Συμπληρώσατε το τηλέφωνο σας;';
$emptymessage = 'Συμπληρώσατε κάποιο μήνυμα;';

//       Various messages displayed when the fields are incorrectly formatted.
$alertname =  'Entering your name using only the standard alphabet?';
$alertemail = 'Συμπληρώστε το email σας με αυτή την μορφή: <i>name@example.com</i>?';
